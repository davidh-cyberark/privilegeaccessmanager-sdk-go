...
1. After confirming that the topic doesn't already exist, you'll need to click `New Issue` to create it.
...
After amending a commit, you will need to force-push (`git push -f <branch_name>`) to your branch for this to take effect.
...
1. The project should be listed in the dropdown-list in [README.md](README.md), under its respective team

2. Within the project's own repository, a CONTRIBUTING.md file should be the standard entry-point
...
3. Templates for issues can improve the information gathered for a new issue, and provide helpful
